...
// export const WALLKIT_POPUP_DEV_URL = 'http://192.168.0.105:8000';
...
var SDK = /*#__PURE__*/function () {
  function SDK(options) {
    ...
    console.log('this.#apiUrl', (0, _classPrivateFieldGet6["default"])(this, _apiUrl), options);
    if (window.Wallkit) {
      this.onLoad();
    } else {
      this.load();
