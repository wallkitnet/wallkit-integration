...
var TRIGGER_EMAIL_BUTTON_CLASS_NAME = 'wk-auth-form-button'; // Authentication
...
var DEFAULT_AUTH_FORM_SLUG_UPDATED = 'default-auth-form-slug-updated'; // Wallkit Events Names
...
var _classPrivateFieldGet4 = _interopRequireDefault(__webpack_require__(9704));
...
var TriggerButton = /*#__PURE__*/function () {
  function TriggerButton(selector, options) {
    ...
    _changeAuthButtonsTitle.add(this);

    _changeAuthButtonsTitleColor.add(this);
    ...
    _buttonsTitleSelector.set(this, {
      writable: true,
      value: {
  ...
  if (authNew && authNew !== authOld && [_AuthForm.SIGN_UP_FORM_SLUG, _AuthForm.SIGN_IN_FORM_SLUG].includes(authNew)) {
    ...
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
        ...
        if ((0, _lodash["default"])(authProvider.provider)) continue;
        var aProvider = authProvider.provider.toLowerCase();
        var _classPrivateFieldGet3 = (0, _classPrivateFieldGet4["default"])(this, _options)[aProvider],
        ...
        if (!(0, _lodash["default"])((0, _classPrivateFieldGet4["default"])(this, _options)[aProvider]) && (!(0, _lodash["default"])(signInLabel) || !(0, _lodash["default"])(signUpLabel))) {
          (function () {
