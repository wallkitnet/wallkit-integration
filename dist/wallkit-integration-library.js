  ...
  (0, _createClass2["default"])(TriggerButton, [{
    ...
    value: function subscribeEventForChanges() {
      ...
      this.events.subscribe(_eventsName.DEFAULT_AUTH_FORM_SLUG_UPDATED, function (value) {
        if (value !== null && value !== void 0 && value["new"] && value["new"] !== value.old) {
          _classPrivateMethodGet(_this, _changeAuthButtonsTitle, _changeAuthButtonsTitle2).call(_this, value["new"], value.old);
        }
      });
    }
  }, {
    ...
    value: function createElement() {
      ...
      var _classPrivateFieldGet2 = (0, _classPrivateFieldGet5["default"])(this, _options)[elementKey],
      ...
      return (0, _DOM.createElement)('div', {
        className: (0, _classPrivateFieldGet5["default"])(this, _className),
...
function _changeAuthButtonsTitleColor2() {
  ...
  try {
    var _loop = function _loop() {
      ...
      var aProvider = authProvider.provider.toLowerCase();
      var textColor = (_classPrivateFieldGet3 = (0, _classPrivateFieldGet5["default"])(_this2, _options)[aProvider]) === null || _classPrivateFieldGet3 === void 0 ? void 0 : _classPrivateFieldGet3.textColor;
      if (aProvider !== 'email' && textColor) {
        var buttonsTitle = document.querySelectorAll((0, _classPrivateFieldGet5["default"])(_this2, _buttonsTitleSelector)[aProvider]);
        if (buttonsTitle) {
  ...
  if (authNew && authNew !== authOld && [_AuthForm.SIGN_UP_FORM_SLUG, _AuthForm.SIGN_IN_FORM_SLUG].includes(authNew)) {
    ...
    try {
      var _loop2 = function _loop2() {
        ...
        if ((0, _lodash["default"])(authProvider.provider)) return "continue";
        var aProvider = authProvider.provider.toLowerCase();
        var _classPrivateFieldGet4 = (0, _classPrivateFieldGet5["default"])(_this3, _options)[aProvider],
        ...
        if (!(0, _lodash["default"])((0, _classPrivateFieldGet5["default"])(_this3, _options)[aProvider]) && (!(0, _lodash["default"])(signInLabel) || !(0, _lodash["default"])(signUpLabel))) {
          var buttonsTitle = document.querySelectorAll((0, _classPrivateFieldGet5["default"])(_this3, _buttonsTitleSelector)[aProvider]);
